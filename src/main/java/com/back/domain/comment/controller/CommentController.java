...
public class CommentController {
    ...
    @Transactional
    public String delete(@PathVariable(value = "postId") int postId, @PathVariable("commentId") int commentId){
        Post post = postService.findById(postId).get();
    ...
    public String modify(@PathVariable("postId") int postId,
    ...
    @Transactional
    public String modify(@PathVariable("postId") int postId,
                         @PathVariable("commentId") int commentId, @Valid ModifyRequestForm form
    ){
        Post post = postService.findById(postId).get();
        Comment comment = post.findCommentById(commentId).get();
